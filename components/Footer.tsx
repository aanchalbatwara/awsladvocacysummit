    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-lg font-semibold mb-4">Educational Advocacy Summit</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/schedule/in-person" className="text-gray-400 hover:text-white transition-colors">
                  In-Person Schedule
                </Link>
              </li>
              <li>
                <Link href="/schedule/virtual" className="text-gray-400 hover:text-white transition-colors">
                  Virtual Schedule
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="text-gray-400">
                ...
                <a href="mailto:roz@awsp.org" className="hover:text-white transition-colors">
                  roz@awsp.org
                </a>
              </li>
              <li className="text-gray-400">
                <div className="font-semibold text-white">James Laymen</div>
                <a href="mailto:james@awsleaders.org" className="hover:text-white transition-colors">
